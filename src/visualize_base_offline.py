...
MODEL_DIR = "../results/base_model_offline"
OUTPUT_DIR = "../results/base_model_offline"
TIMESTEP = 0.0396
...
model.load_state_dict(torch.load(f"{MODEL_DIR}/base_model_offline.pth", map_location=device))
model.eval()
...
plt.suptitle(f'Base Model - PSNR: {psnr:.2f} dB - Timestep: {TIMESTEP}',
...
evaluation_results = {
    'model_file': 'base_model_offline.pth',
