"""
Large Model Online Visualization
...
MODEL_DIR = "../results/large_model_online"
OUTPUT_DIR = "../results/large_model_online"
TIMESTEP = 0.0396

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("Large model online visualization")
...
plt.suptitle(f'Large Model (128-128-64) Online - PSNR: {psnr:.2f} dB - Timestep: {TIMESTEP}',
...
evaluation_results = {
    'model_file': 'large_model_online_final.pth',
...
print("Large model online visualization completed")
