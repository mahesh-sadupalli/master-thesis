...
Trains base compressor (4→64→64→32→4) using temporal window approach
...
import pandas as pd
from unified_training_utils import SpatioTemporalDataset, BaseCompressor
