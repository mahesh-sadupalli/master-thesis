...
MODEL_DIR = str(PROJECT_ROOT / "results" / "base_model_online")
...
plt.tight_layout()
plt.savefig(f"{OUTPUT_DIR}/base_online_visualization.png", dpi=150, bbox_inches='tight')
print(f"Visualization saved: {OUTPUT_DIR}/base_online_visualization.png")
plt.close()
