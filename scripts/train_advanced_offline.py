"""
Advanced Model Offline Training
...
save_metrics_to_csv(metrics, f"{OUTPUT_DIR}/advanced_model_metrics.csv")
...
plt.suptitle('Advanced Model (128-128-64) - Offline Training',
             fontsize=16, fontweight='bold')
plt.tight_layout()
plt.savefig(f"{OUTPUT_DIR}/advanced_model_training_progress.png", dpi=300, bbox_inches='tight')
print(f"Training plot saved: {OUTPUT_DIR}/advanced_model_training_progress.png")
plt.close()

print("Advanced model offline training completed")
